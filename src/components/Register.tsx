...
export default function Register({ isDark }: { isDark: boolean }) {
  ...
  const handleGoogleSuccess = async (credentialResponse: any) => {
    ...
    try {
      ...
      // Send them to login to complete the loop
      navigate("/login");
    } catch (err: any) {
          ...
          <div className="px-8 pt-8 pb-10">
            ...
            >
              ...
              >
                ...
                <span className="shimmer-text font-semibold">building</span>{" "}
                better meals
              </p>
            </motion.div>
            ...
            >
              ...
              >
                <UserIcon
                  className={`absolute left-4 top-3.5 w-4 h-4 transition-colors duration-300 ${focusedField === "username" ? "text-orange-500" : isDark ? "text-stone-600" : "text-stone-400"}`}
                />
                <input
                  type="text"
              ...
              >
                <Mail
                  className={`absolute left-4 top-3.5 w-4 h-4 transition-colors duration-300 ${focusedField === "email" ? "text-orange-500" : isDark ? "text-stone-600" : "text-stone-400"}`}
                />
                <input
                  type="email"
